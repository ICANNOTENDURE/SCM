...
import com.dhcc.pms.entity.platformManage.Cert;
import com.dhcc.pms.service.platformManage.CertService;
import com.opensymphony.xwork2.ActionSupport;

/**
 * 标题: DownLoadCertKeyAction.java
 * 业务描述：安全运维管理平台
 * 公司:东华软件股份公司
 * 版权:dhcc2013
 * @author 聂文来
...
public class DownLoadCertKeyAction extends ActionSupport{
	...
	public InputStream getInputStream(){
		try {
			...
			this.setFileName(certSerialNum+".key");
			Cert cert = this.certService.getCert(certSerialNum);

			InputStream is = new ByteArrayInputStream(cert.getCertKeyInfo().getBytes("UTF-8"));
			return is;
		} catch (Exception e) {
			e.printStackTrace();
