		...
		try {
			...
			if("".equals(certDto.getCert().getCertId())){
				...
				if(rootCert!=null){
					...
					com.dhcc.pms.tool.cert.Cert certTool = new com.dhcc.pms.tool.cert.Cert(1024);
