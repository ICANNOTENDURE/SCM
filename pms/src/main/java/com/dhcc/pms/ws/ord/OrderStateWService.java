...
public class OrderStateWService implements OrderStateWServiceInterface{
    ...
    */
    @Override
    @WebMethod
    public OperateResult recievedMsg(Long orderId) {
    ...
    */
    @Override
    @WebMethod
    public OperateResult deliver(List<VenDeliveritm> deliveritms) {
    ...
    */
    @Override
    @WebMethod
    public List<OrderWebVo> listOrderWS(String passWord, String userName) {
