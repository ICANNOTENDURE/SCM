...
var dictDefault={'list':[],'getted':false,'data':{}};
if(!$(document).data('pageCombos'))
$(document).data('pageCombos',{});
if(!$(document).data('pageCombos')[dict])
$(document).data('pageCombos')[dict]=dictDefault;
if(-1===$.inArray($(this),$(document).data('pageCombos')[dict]['list'])) {
$(document).data('pageCombos')[dict]['list'].push($(this));
}
}
if(_47.options.data){
...
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{dict:null,valueField:"value",textField:"text",mode:"local",method:"post",url:null,data:null,keyHandler:{up:function(){
_6(this);
},down:function(){
_e(this);
},enter:function(){
